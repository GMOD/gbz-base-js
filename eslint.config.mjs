...
export default defineConfig(
  {
    ignores: [
      'scripts',
      // plain js that imports the built dist/, so it neither parses under the
      // type-aware config nor type-checks before a build
      'bin/*',
      'dist/*',
      // generated by `pnpm coverage`; the report ships its own bundled js,
      // which tsconfig.lint.json doesn't cover, so linting it is a hard parser
